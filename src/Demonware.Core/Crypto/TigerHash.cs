...
namespace Demonware.Core.Crypto
{
    ...
    public sealed class TigerHash : HashAlgorithm
    {
        ...
        private void ProcessBlock()
        {
            ...
            //int blockIndex = 0;
            //ulong[] block = this.block;
            //byte[] buffer = this.internalDataBuffer;

            //for (int offset = 0; offset < BLOCKSIZE; offset += 8)
            //{
            //    block[blockIndex] =
            //        (((ulong)buffer[offset + 7]) << 56) |
            //        ((((ulong)buffer[offset + 6]) & 0xFF) << 48) |
            //        ((((ulong)buffer[offset + 5]) & 0xFF) << 40) |
            //        ((((ulong)buffer[offset + 4]) & 0xFF) << 32) |
            //        ((((ulong)buffer[offset + 3]) & 0xFF) << 24) |
            //        ((((ulong)buffer[offset + 2]) & 0xFF) << 16) |
            //        ((((ulong)buffer[offset + 1]) & 0xFF) << 8) |
            //        (((ulong)buffer[offset]) & 0xFF);
        ...
        private void Schedule(ulong[] x)
        {
            ...
            x[4] = x[4] ^ x[3];
            x[5] += x[4];
            x[6] -= x[5] ^ (((~x[4]) >> 23) & 0x1FFFFFFFFFF);
            x[7] = x[7] ^ x[6];
            x[0] += x[7];
            x[1] -= x[0] ^ ((~x[7]) << 19);
            x[2] = x[2] ^ x[1];
            x[3] += x[2];
            x[4] -= x[3] ^ (((~x[2]) >> 23) & 0x1FFFFFFFFFF);
            x[5] = x[5] ^ x[4];
            x[6] += x[5];
        ...
        #region [ static readonly ulong[] T    ]
        private static readonly ulong[] T =
		{
			0x2AAB17CF7E90C5E, 0xAC424B03E243A8EC, 0x72CD5BE30DD5FCD3, 0x6D019B93F6F97F3A, 
			0xCD9978FFD21F9193, 0x7573A1C9708029E2, 0xB164326B922A83C3, 0x46883EEE04915870, 
			0xEAACE3057103ECE6, 0xC54169B808A3535C, 0x4CE754918DDEC47C, 0xAA2F4DFDC0DF40C, 
			...
			0x9053836C15957613, 0xDB6DCF8AFC357BF1, 0x18BEEA7A7A370F57, 0x37117CA50B99066, 
			...
			0x6A7D1A32823C958, 0x6F95FE5130F61119, 0xD92AB34E462C06C0, 0xED7BDE33887C71D2, 
			...
			0x24F6EC65B528D56C, 0xCE1512E90F4524A, 0x4E9DD79D5506D35A, 0x258905FAC6CE9779, 
			...
			0xBD7BA3EBB5DC726, 0xE54BCA55B86ADB39, 0x1D7A3AFD6C478063, 0x519EC608E7669EDD, 
			0xE5715A2D149AA23, 0x177D4571848FF194, 0xEEB55F3241014C22, 0xF5E5CA13A6E2EC2, 
			0x8029927B75F5C361, 0xAD139FABC3D6E436, 0xD5DF1A94CCF402F, 0x3E8BD948BEA5DFC8, 
			0xA5A0D357BD3FF77E, 0xA2D12E251F74F645, 0x66FD9E525E81A082, 0x2E0C90CE7F687A49, 
			0xC2E8BCBEBA973BC5, 0x1BCE509745F, 0x423777BBE6DAB3D6, 0xD1661C7EAEF06EB5, 
			...
			0x9BD37013FEFF9FE8, 0x3F9B0404D6085A06, 0x4940C1F3166CFE15, 0x9542C4DCDF3DEFB, 
			0xB4C5218385CD5CE3, 0xC935B7DC4462A641, 0x3417F8A68ED3B63F, 0xB80959295B215B40, 
			0xF99CDAEF3B8C8572, 0x18C0614F8FCB95D, 0x1B14ACCD1A3ACDF3, 0x84D471F200BB732D, 
			...
			0xFA209DA84220728D, 0x9E691D9B9EFE23F7, 0x446D288C4AE8D7F, 0x7B4CC524E169785B, 
			0x21D87F0135CA1385, 0xCEBB400F137B8AA5, 0x272E2B66580796BE, 0x3612264125C2B0DE, 
			0x95F34C9A12B97F0, 0x247AB64525D60CA8, 0xDCDBC6F3017477D1, 0x4A2E14D4DECAD24D, 
			0xBDB5E6D9BE0A1EEB, 0x2A7E70F7794301AB, 0xDEF42D8A270540FD, 0x1078EC0A34C22C1, 
			0xE5DE511AF4C16387, 0x7EBB3A52BD9A330A, 0x77697857AA7D6435, 0x4E831603AE4C32, 
			0xE7A21020AD78E312, 0x9D41A70C6AB420F2, 0x28E06C18EA1141E6, 0xD2B28CBD984F6B28, 
			0x26B75F6C446E9D83, 0xBA47568C4D418D7F, 0xD80BADBFE6183D8E, 0xE206D7F5F166044, 
			...
			0xD33D06565CF620F, 0x54A48D489F219CA1, 0xC43E5EAC6D63C821, 0xA9728B3A72770DAF, 
			...
			0x2E60F512C0A07884, 0xBC3D86A3E36210C9, 0x35269D9B163951CE, 0xC7D6E2AD0CDB5FA, 
			0x59E86297D87F5733, 0x298EF221898DB0E7, 0x55000029D1A5AA7E, 0x8BC08AE1B5061B45, 
			0xC2C31C2B6C92703A, 0x94CC596BAF25EF42, 0xA1D73DB22540456, 0x4B6A0F9D9C4179A, 
			...
			0x74A05B6F5D3CECCB, 0xB610021542E13ECA, 0xFF979D12F59E2AC, 0x6037DA27E4F9CC50, 
			...
			0x5DB0A76CE35AFC2, 0x81EAC77EA9113D45, 0x528EF88AB6AC0A0D, 0xA09EA253597BE3FF, 
			0x430DDFB3AC48CD56, 0xC4B3A67AF45CE46F, 0x4ECECFD8FBE2D05E, 0x3EF56F10B39935F0, 
			0xB22D6829CD619C6, 0x17FD460A74DF2069, 0x6CF8CC8E8510ED40, 0xD6C824BF3A6ECAA7, 
			0x61243D581A817049, 0x48BACB6BBC163A2, 0xD9A38AC27D44CC32, 0x7FDDFF5BAAF410AB, 
			0xAD6D495AA804824B, 0xE1A6A74F2D8C9F94, 0xD4F7851235DEE8E3, 0xFD4B7F886540D893, 
			0x247C20042AA4BFDA, 0x96EA1C517D1327C, 0xD56966B4361A6685, 0x277DA5C31221057D, 
			...
			0xED152665953E7671, 0x2D63194A6369570, 0x5074F08394B1C987, 0x70BA598C90B25CE1, 
			0x794A15810B9742F6, 0xD5925E9FCAF8C6C, 0x3067716CD868744E, 0x910AB077E8D7731B, 
			0x6A61BBDB5AC42F61, 0x93513EFBF0851567, 0xF494724B9E83E9D5, 0xE887E1985C09648D, 
			0x34B1D3C675370CFD, 0xDC35E433BC0D255D, 0xD0AAB84234131BE0, 0x8042A50B48B7EAF, 
			...
			0xF6F64FCEC15F389, 0x74EFBE618B5B13C8, 0xACDC82B714273E1D, 0xDD40BFE003199D17, 
			...
			0x855E3602D2D4E022, 0x73805BAD01F784C, 0x33E17A133852F546, 0xDF4874058AC7B638, 
			0xBA92B29C678AA14A, 0xCE89FC76CFAADCD, 0x5F9D4E0908339E34, 0xF1AFE9291F5923B9, 
			...
			0x10168168C3F96B6B, 0xE3D963B63CAB0AE, 0x8DFC4B5655A1DB14, 0xF789F1356E14DE5C, 
			...
			0xA234AA642391484, 0xF6F9508028F80D9D, 0xB8E319A27AB3F215, 0x31AD9C1151341A4D, 
			...
			0x409F753600C879FC, 0x6D09A39B5926DB6, 0x6F83AEB0317AC588, 0x1E6CA4A86381F21, 
			...
			0x3F38C96BA582C52, 0xCAD1BDBD7FD85DB2, 0xBBB442C16082AE83, 0xB95FE86BA5DA9AB0, 
			...
			0x5490ADEC7ECE57D4, 0x2B3C27D9063A3A, 0x7EAEA3848030A2BF, 0xC602326DED2003C0, 
